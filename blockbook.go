...
import (
	...
	"github.com/mosqueiro/blockbook-coins/bchain/coins"
	"github.com/mosqueiro/blockbook-coins/common"
	"github.com/mosqueiro/blockbook-coins/db"
	"github.com/mosqueiro/blockbook-coins/fiat"
	"github.com/mosqueiro/blockbook-coins/server"
	"io/ioutil"
	"log"
	"math/rand"
	"net/http"
...
func mainWithExitCode() int {
	...
	index, err = db.NewRocksDB(*dbPath, uint64(*dbCache), *dbMaxOpenFiles, chain.GetChainParser(), metrics)
	if err != nil {
